  ...
  return (
    <section className="section-fullpage py-8 md:py-12" style={{ scrollSnapAlign: 'start' }}>
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10 px-5 sm:px-8 md:px-12">
        ...
        <div className="mt-16 animate-fade-up delay-600">
          <div className="card-premium p-8 md:p-10 rounded-3xl">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {stats.map((stat, i) => (
                <div key={i} className="text-center group">
                  <div className="flex justify-center mb-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-gold flex items-center justify-center group-hover:scale-110 transition-transform duration-500 shadow-gold">
                      <svg className="w-6 h-6 text-off-white" fill="currentColor" viewBox="0 0 20 20">
                        {stat.icon === "users" && (
                  ...
                  <p className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-gradient-gold mb-1">{stat.number}</p>
                  <p className="text-xs md:text-sm uppercase tracking-[0.1em] text-muted-foreground font-medium">{stat.label}</p>
                </div>
              ))}
            </div>
          </div>
