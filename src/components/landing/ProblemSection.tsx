  ...
  return (
    <section className="section-fullpage py-8 md:py-12" style={{ scrollSnapAlign: 'start' }}>
      ...
      <div className="w-full max-w-6xl mx-auto relative z-10 px-4 sm:px-8 md:px-12">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-5 animate-slide-in-right">
            {painPoints.map((point, index) => (
              ...
              >
                <div className="card-premium p-4 sm:p-6 rounded-xl sm:rounded-2xl flex items-center gap-3 sm:gap-5 transition-all duration-500 hover:shadow-xl hover:-translate-x-2 border-l-4 border-l-terracotta/70 hover:border-l-gold">
                  <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-rose/50 flex items-center justify-center text-xl sm:text-3xl flex-shrink-0 group-hover:scale-110 transition-transform duration-500">
                    {point.emoji}
                  </div>
                  <p className="text-foreground font-medium text-sm sm:text-lg leading-relaxed">{point.text}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mt-24 pt-8 animate-fade-up delay-600">
          <div className="relative max-w-4xl mx-auto">
            {/* Glow effect */}
            <div className="absolute inset-0 bg-gradient-radial-gold blur-3xl opacity-30" />
            
            <div className="relative card-premium p-10 md:p-14 pt-14 md:pt-16 rounded-3xl text-center border-2 border-gold/30 overflow-visible">
              {/* Top decoration */}
              ...
              <p className="text-3xl md:text-4xl lg:text-5xl font-display text-gradient-gold italic font-semibold">
