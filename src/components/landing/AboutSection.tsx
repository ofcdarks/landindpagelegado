        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="animate-slide-in-right order-1 lg:order-2">
            <div className="flex items-center gap-3 sm:gap-5 mb-6 sm:mb-8">
              ...
              <span className="text-xs sm:text-sm uppercase tracking-[0.15em] sm:tracking-[0.2em] text-gold font-bold">Conheça sua mentora</span>
            </div>

            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-medium text-foreground leading-[1.1] mb-6 sm:mb-10">
              Prazer,
              <span className="block text-gradient-gold italic mt-2">Tali Almeida</span>
            </h2>

            <div className="space-y-4 sm:space-y-6 text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed font-light">
              <p>
              ...
              <div className="relative pl-8 border-l-4 border-gold/50 py-2">
              ...
              <p className="text-xl md:text-2xl text-foreground font-display font-medium py-4">
            ...
            <div className="mt-8 sm:mt-10 space-y-4">
              <div className="relative p-5 sm:p-6 rounded-2xl bg-gradient-card border border-gold/20 shadow-lg">
                <div className="absolute -top-3 -left-3 w-8 h-8 rounded-full bg-gradient-gold flex items-center justify-center shadow-gold">
                ...
                <p className="text-gold font-semibold mt-3 text-sm">— Tali Almeida</p>
              </div>
